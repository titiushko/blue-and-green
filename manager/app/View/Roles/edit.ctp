...
<?php echo $this->Form->create('Role'); ?>
	...
	<?php
		echo $this->Form->input('codigo_rol');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Role.codigo_rol')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Role.codigo_rol'))); ?></li>
