 ...
 * 
 */
class TipoFacturacion extends AppModel
{
	var $name = 'TipoFacturacion';
	var $displayField= 'que';
	var $useTable = 'tipofacturacion';
	...
	//var $validate = array('descripcion'=>VALID_NOT_EMPTY );
/**/
}
