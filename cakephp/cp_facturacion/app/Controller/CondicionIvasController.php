 ...
 * 
 */
class CondicionIvasController extends AppController
{
	var $Modelo = 'CondicionIva';
	var $name = 'CondicionIvas';
	//var $layout = 'ajax';
	var $scaffold;
	var $helpers = array('Html','Js','Paginator');
	var $components = array('Paginator');
	
	function indexxx($ajax = null)
	{
		if($ajax)$this->layout = 'ajax';
		$this->Condicioniva->recursive = 2;
        $this->set('elementos', $this->Condicioniva->findAll() ); 		
	}
