...
<?php echo $this->Form->create('Responsable'); ?>
	...
	<?php
		echo $this->Form->input('codigo_responsable');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Responsable.codigo_responsable')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Responsable.codigo_responsable'))); ?></li>
