...
<?php echo $this->Form->create('Tienda'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tienda'); ?></legend>
	<?php
		echo $this->Form->input('codigo_tienda');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Tienda.codigo_tienda')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Tienda.codigo_tienda'))); ?></li>
