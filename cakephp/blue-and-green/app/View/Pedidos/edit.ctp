...
<?php echo $this->Form->create('Pedido'); ?>
	...
	<?php
		echo $this->Form->input('codigo_pedido');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Pedido.codigo_pedido')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Pedido.codigo_pedido'))); ?></li>
